        ...
        setupLightboxHtml: function() {
            ...
            if (!this.$el) {
                        ...
                        '<div class="slbWrapOuter">' +
                            '<div class="slbWrap">' +
                                '<div class="slbContentOuter">' +
                                    ...
                                    '<button type="button" title="' + 'Zamknij' + '" class="slbCloseBtn ' + o.closeBtnClass + '">×</button>' +
                                '</div>' +
                            '</div>' +
                        '</div>' +
                    '</div>'                                               
                ...
                if (this.items.length > 1) {
                    ...
                    $(
                        '<div class="slbArrows">' +
                            '<button type="button" title="' + 'Poprzedni' + '" class="prev slbArrow' + o.prevBtnClass + '"></button>' +
                            '<button type="button" title="' + 'Następny' + '" class="next slbArrow' + o.nextBtnClass + '"></button>' +
